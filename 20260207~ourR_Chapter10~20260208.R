...
#10.6 array
#10.6.1 Create array-type data
Mat1 <- matrix (sample (1:12, 12, replace = T), byrow = T, nrow = 3)
Mat2 <- matrix (sample (1:12, 12, replace = T), byrow = T, nrow = 3)
Mat3 <- matrix (sample (1:12, 12, replace = T), byrow = T, nrow = 3)
Mat4 <- matrix (sample (1:12, 12, replace = T), byrow = T, nrow = 3)

Array1 <- array (c(Mat1, Mat2, Mat3, Mat4), dim = c(3, 4, 4))
class (Array1)
Array1

#Operating array-type data
Array1 [,,3]
...
Array1 [1:2, 1:2,]
#Eacy arrays row = 1 and 2, col = 1 and 2

#I want to assign names to a matrix
